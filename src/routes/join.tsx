...
export const Route = createFileRoute("/join")({
  head: () => ({
    meta: [
      { title: "Join a folder — Atlas Study Workspace" },
      {
        name: "description",
        content: "Enter the 6-digit invite code you received from a friend to join their folder.",
      },
      { property: "og:title", content: "Join a folder — Atlas Study Workspace" },
      {
        property: "og:description",
        content: "Enter an invite code to join a shared study folder on Atlas.",
      },
    ],
  }),
  component: JoinPage,
